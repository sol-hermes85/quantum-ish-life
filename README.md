...
- **Preset pattern**: seed a glider, blinker, lightweight spaceship, acorn, diehard, toad, pulsar, beacon, or random soup
...
- **Keyboard shortcuts**: Space play/pause, `S` step, `R` random, `C` clear, `I` invert, `E` paint/erase, `H` hide/show controls, `Z` reset view
